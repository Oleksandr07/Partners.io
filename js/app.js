...
// 	});
// });
/* - - - - - - - - - - - - - -       scroll to       - - - - - - - - - - - - - - - */if(window.location.hash!==''){setTimeout(function(){var posTop=$(window.location.hash).offset().top-parseInt($(window.location.hash).css('padding-top'))-$('.header').innerHeight();$('html, body').animate({'scrollTop':posTop+'px'},500)},100)}$(document).on('click','.js-scroll-to',function(e){if(window.location.pathname==='/'){e.preventDefault()}// else {
